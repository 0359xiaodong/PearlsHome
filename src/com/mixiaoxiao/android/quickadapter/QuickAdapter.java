 ...
 */
package com.mixiaoxiao.android.quickadapter;
...
import static com.mixiaoxiao.android.quickadapter.BaseAdapterHelper.get;
...
public abstract class QuickAdapter<T> extends BaseAdapter {
    ...
    public QuickAdapter(Context context, int layoutResId, List<T> data) {
        this.data = data == null ? new ArrayList<T>() : data;//new ArrayList<T>(data);
